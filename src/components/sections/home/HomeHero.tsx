  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1120px]">
        ...
        <h1 className="mt-4 text-[36px] font-extrabold leading-[1.02] tracking-[-1.2px] sm:text-[49px] sm:tracking-[-1.6px]">
          <span className="text-[#f2effb]">Code changes too fast to understand.</span>
          <br />
