...
const releaseGroups: { month: string; entries: { label: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        label:
          "Baseline workflow: blessed golden trace baselines and agent-added labels commit to the PR branch",
        href: "https://github.com/getappmap/review-action",
      },
    ],
  },
  {
    ...
    entries: [
      {
        label:
          "Golden trace review workflow: promote a recording to a baseline, compare before and after on every change",
        href: "https://github.com/getappmap/skills",
      },
      {
        label:
...
export const Route = createFileRoute("/release-notes")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/release-notes" },
    ...
    links: [{ rel: "canonical", href: "/release-notes" }],
  }),
