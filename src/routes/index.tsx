...
const description =
  "Code changes outrun our understanding. See how every change behaves before it merges. AppMap records locally in your environment, commits the key traces to the repository, and coding agents and developers verify every change against them.";
