...
const description =
  "AI writes code fast. See how every change behaves before merge. AppMap gives developers and coding agents the same runtime evidence to understand, compare, and act on each change before it merges.";
