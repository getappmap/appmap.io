...
const description =
  "AI writes code fast. Knowing what the change does is still the hard part. AppMap records application runs as traces. Developers see them as maps, coding agents query the same traces, and AppMap compares Gold Traces across revisions to show behavioral diffs before merge.";
