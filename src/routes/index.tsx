...
const description =
  "Code changes too fast to catch what breaks. See how every change behaves before it merges. AppMap gives developers and coding agents the same runtime evidence to understand, compare, and act on each change before it merges.";
